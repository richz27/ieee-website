...
const HeroSection = () => {
    return (
        <>
            <div className="flex flex-col justify-center items-center bg-cover bg-center bg-no-repeat min-h-screen bg-blend-overlay md:bg-fixed bg-black/30" style={{backgroundImage: `url(${muddLibrary})`}}>
